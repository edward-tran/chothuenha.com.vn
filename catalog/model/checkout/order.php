	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'payment_ward'            => $order_query->row['payment_ward'],
				...
				'shipping_ward'           => $order_query->row['shipping_ward'],
