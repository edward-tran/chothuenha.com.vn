            ...
            if($result['installed']){
                ...
                if(isset($mbooth['install'])){
                    if(isset($mbooth['install']['url'])){
                        ...
                        $result['activate'] = str_replace('&amp;', '&', $this->url->link($routing, implode('&', $parts).'&token='.$this->session->data['token'], 'SSL'));
                    }
                }
                ...
                if(isset($mbooth['uninstall'])){
                    if(isset($mbooth['uninstall']['url'])){
                        ...
                        $result['deactivate'] = str_replace('&amp;', '&', $this->url->link($routing, implode('&', $parts).'&token='.$this->session->data['token'], 'SSL'));
                    }
                }
            }
