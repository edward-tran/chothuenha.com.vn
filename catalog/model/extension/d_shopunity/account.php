...
//NEEDS REFACTOR
	...
	//TODO
	public function getAuthorizeUrl($callback_routing){
		return $this->api->getAuthorizeUrl($this->url->link($callback_routing, 'token=' . $this->session->data['token'], 'SSL'));
	}

	public function getToken($callback_routing){
		$json = array();
		if(isset($this->request->get['code'])){
			$resource = array( 
		        ...
		        'redirect_uri' => urlencode($this->url->link($callback_routing, 'token=' . $this->session->data['token'], 'SSL'))
			);
