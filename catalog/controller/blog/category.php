					...
					foreach ($parts as $path_id) {
						...
						if ($category_info) {
							$data['breadcrumbs'][] = array(
								...
								'href'      => (isset($category_info['external_link']) ? $category_info['external_link'] : $this->url->link('blog/category', 'blog_category_id=' . $path . $url)),
								'separator' => $this->language->get('text_separator')
							);
						}
					}
				...
				if ($category_info) {
					...
					foreach ($results as $result) {
						...
						$data['categories'] = array(
							...
							'href'  => $this->url->link('blog/category', 'blog_category_id=' . $this->request->get['blog_category_id'] . '_' . $result['blog_category_id'])
						);						
					}
					...
					$blog_total = $this->model_blog_article->getTotalArticleCategoryWise($filter_data); 
