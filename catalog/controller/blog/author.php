	...
	class ControllerBlogAuthor extends Controller {
		public function index() {
			...
			if($blog_author_id) {
				...
				$results = $this->model_blog_article->getArticleAuthorWise($filter_data);
				...
				$pagination->url = $this->url->link('blog/author', 'blog_author_id=' . $this->request->get['blog_author_id'] . '&page={page}');
