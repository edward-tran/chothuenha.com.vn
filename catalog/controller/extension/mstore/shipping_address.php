...
class ControllerExtensionMstoreShippingAddress extends Controller {
	...
	/**
	 * @api {post} /index.php?routing=extension/mstore/shipping_address/save Set shipping address
	 * @apiVersion 0.1.0
	...
	private function validate($params){
		...
		if ((utf8_strlen(trim($params['ward'])) < 2) || (utf8_strlen(trim($params['ward'])) > 128)) {
