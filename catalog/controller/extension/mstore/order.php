...
class ControllerExtensionMstoreOrder extends Controller {
	...
	/**
	 * @api {get} /index.php?routing=extension/mstore/order/orders Get my orders
	 * @apiVersion 0.1.0
	...
	/**
	 * @api {post} /index.php?routing=extension/mstore/order/confirm Confirm order
	 * @apiVersion 0.1.0
	...
	public function confirm() {
		...
		foreach ($products as $product) {
			...
			$order_data['payment_ward'] = $this->session->data['payment_address']['ward'];
