...
class ControllerExtensionMstoreShippingMethod extends Controller {
	...
	/**
	 * @api {get} /index.php?routing=extension/mstore/shipping_method Get shipping methods
	 * @apiVersion 0.1.0
	...
	/**
	 * @api {post} /index.php?routing=extension/mstore/shipping_method/save Set shipping method
	 * @apiVersion 0.1.0
