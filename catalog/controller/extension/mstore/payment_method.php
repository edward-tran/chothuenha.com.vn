...
class ControllerExtensionMstorePaymentMethod extends Controller {
	private $error = array();
	/**
	 * @api {get} /index.php?routing=extension/mstore/payment_method Get payment methods
	 * @apiVersion 0.1.0
	...
	/**
	 * @api {post} /index.php?routing=extension/mstore/payment_method/save Set payment method
	 * @apiVersion 0.1.0
