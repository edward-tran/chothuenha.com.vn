...
class ControllerExtensionDShopunityExtension extends Controller {
	...
	/**	
	 * Get extension data with index.php?routing=d_shopunity/extension&codename=d_shopunity&secret=test
	 */
	...
	/**	
	 * Dowbload with index.php?routing=d_shopunity/extension/download&codename=d_shopunity&secret=test
	 */
	...
	/**	
	 * Delete with index.php?routing=d_shopunity/extension/uninstall&codename=d_shopunity&secret=test
	 */
