...
class ControllerExtensionModuleDQuickcheckout extends Controller {
    ...
    private $routing = 'extension/module/d_quickcheckout';
    ...
    public function __construct($registry) {
        ...
        $this->load->model('extension/d_iiwi_patch/load');
        $this->load->model('account/address');
        // $this->load->language($this->routing);
    ...
    public function index() {
        ...
        return $this->model_extension_d_iiwi_patch_load->view('module/d_quickcheckout', $data);
...
$this->load->model('extension/d_quickcheckout/address');
        ...
        if($this->setting['general']['clear_session']){
            ...
            $this->session->data['payment_address'] = array(
                ...
                'ward' => $this->setSessionValue('ward','payment_address', $data, $account, false),
            ...
            $this->session->data['shipping_address'] = array(
                ...
                'ward' => $this->setSessionValue('ward','shipping_address', $data, $account, false),
            ...
            $this->session->data['payment_address'] = array(
                ...
                'ward' => $this->setSessionValue('ward','payment_address', $data, $account),
            ...
            $this->session->data['shipping_address'] = array(
                ...
                'ward' => $this->setSessionValue('ward','shipping_address', $data, $account),
