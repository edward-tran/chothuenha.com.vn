...
class ControllerExtensionOpenbayFba extends Controller {
	public function eventAddOrderHistory($routing, $data) {
		$this->openbay->fba->log('eventAddOrderHistory Event fired: ' . $routing);
	...
	public function eventAddOrder($routing, $data) {
		$this->openbay->fba->log('eventAddOrder Event fired: ' . $routing);
