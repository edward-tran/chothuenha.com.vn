...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$results = $this->model_catalog_category->getCategories($category_id); // custom
			...
			$product_total = $this->model_catalog_product->getTotalProducts($filter_data); // custom
	...
	public function getAllCategoryByProductTypeId() {
		...
		$results = $this->model_catalog_category->getCategoriesByProductTypeId($product_type_id); // custom
