...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		if (isset($this->session->data['payment_address']['ward'])) {
			$data['ward'] = $this->session->data['payment_address']['ward'];
		} elseif (isset($this->session->data['shipping_address']['ward'])) {
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['payment_address']['ward'] = $this->request->post['ward'];
