<?php 
class ControllerPaymentCustomDirectpay extends Controller {
	public function index() {
		$this->load->language('payment_custom/bank_transfer');
		...
		$this->response->setOutput($this->load->view('payment_custom/directpay', $data));
	}
}