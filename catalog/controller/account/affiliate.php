...
class ControllerAccountAffiliate extends Controller {
	...
	public function getForm() {
		...
		if ($this->request->get['routing'] == 'account/affiliate/add') {
			$data['breadcrumbs'][] = array(
		...
		$data['action'] = $this->url->link($this->request->get['routing'], '', true);
		
		if ($this->request->get['routing'] == 'account/affiliate/edit' && $this->request->server['REQUEST_METHOD'] != 'POST') {
