<?php
class ControllerAccountPostProjectSale extends Controller {
	public function index() {
		...
		$this->document->addScript('catalog/view/theme/beta/js/angular/post_project_sale.js?'.rand());
		...
		$this->load->language('account/post_project_sale');
		...
		$data['product_types'] = $this->model_catalog_product_type->getProductTypes();
		...
		$this->response->setOutput($this->load->view('account/post_project_sale', $data));
	}
