...
;(function($, window, document, undefined) {
     ...
     * @protected
     */
    Owl2.prototype.eventsRoutingr = function(event) {
        var type = event.type;
    ...
    Owl2.prototype.internalEvents = function() {
        ...
        if (this.settings.mouseDrag){
            this.$stage.on('mousedown', $.proxy(function(event) { this.eventsRoutingr(event) }, this));
        ...
        if (this.settings.touchDrag && !isTouchIE){
            this.$stage.on('touchstart touchcancel', $.proxy(function(event) { this.eventsRoutingr(event) }, this));
        }
    ...
    Owl2.prototype.onDragStart = function(event) {
        ...
        $(document).on('mousemove.owl.dragEvents mouseup.owl.dragEvents touchmove.owl.dragEvents touchend.owl.dragEvents', $.proxy(function(event) {this.eventsRoutingr(event)},this));
    };
    ...
    $.fn.owlCarousel = function(options) {
        return this.each(function() {
            if (!$(this).data('owlCarousel')) {
                $(this).data('owlCarousel', new Owl2(this, options));
            }
        });
    };
     ...
     * @public
     */
    $.fn.owlCarousel.Constructor = Owl2;
