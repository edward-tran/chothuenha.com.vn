...
$_['text_greeting']         = 'Cảm ơn bạn đã quan tâm đến dự án %s. Đơn đặt hàng của bạn đã nhận được và sẽ được xử lý một khi khoản thanh toán đã được xác nhận.';
...
$_['text_products']         = 'Dự án';
$_['text_product']          = 'Dự án';
$_['text_model']            = 'Model';
$_['text_quantity']         = 'Số lượng';
$_['text_price']            = 'Giá';
$_['text_order_total']      = 'Tổng đơn hàng';
$_['text_total']            = 'Tổng';
$_['text_download']         = 'Khi thanh toán của bạn đã được xác nhận, bạn có thể nhấp vào liên kết bên dưới để truy cập vào các dự án có thể tải xuống của bạn:';
